...
<div class="back-content">
  ...
  <p class="back-card back-card--note">Les inscriptions s'effectuent depuis le <a href="index.php?r=front/formations">front office</a> (bouton S'inscrire sur une formation). Cette page permet la consultation, la recherche et la suppression.</p>
...
<script src="<?= htmlspecialchars(E_LEARNING_WEB_BASE, ENT_QUOTES, 'UTF-8') ?>/View/assets/js/back-form-validation.js"></script>
