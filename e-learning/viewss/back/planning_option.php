...
<div class="back-content">
  <?php if (!empty($flash)): ?>
    <div id="planning-option-flash-message" data-message="<?= htmlspecialchars($flash, ENT_QUOTES, 'UTF-8') ?>" hidden></div>
  <?php endif; ?>

  <div class="back-card">
    <h2 class="back-card__title">Ajouter une liaison</h2>
    <form method="post" action="index.php?r=back/planning-option/store" id="planning-option-form">
      <div class="form-grid">
        <div class="form-group">
          <label for="id_planning">id_planning</label>
          <select id="id_planning" name="id_planning">
        ...
        <div class="form-group">
          ...
          <select id="id_option" name="id_option">
