      ...
      <div class="page-inner">
        ...
        <div class="page-header">
          <div class="d-flex align-items-center">
            ...
            <a href="index.php?page=offres&action=offres&q=" class="btn btn-primary btn-round ms-3 shadow-sm" style="font-weight: 900; font-size: 1.2rem; min-width: 45px;">
...
<div class="modal fade" id="addExpModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="index.php?page=offres&action=publish" method="POST">
...
<script src="projet wweb/assets/js/plugin/chart.js/chart.min.js"></script>
<script src="projet wweb/assets/js/plugin/datatables/datatables.min.js"></script>
<script src="projet wweb/assets/js/plugin/sweetalert/sweetalert.min.js"></script>
