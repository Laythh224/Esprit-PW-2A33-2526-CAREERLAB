...
<head>
    ...
    <title>Inscriptions Formateurs</title>
...
<body>
    <div class="wrapper">
        <?php $activeAccountPage = 'inscription-formateur'; include __DIR__ . '/../views/components/account-sidebar.php'; ?>
            ...
            <div class="container py-4">
                <div class="row g-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="id_formateur" class="form-select">
                                            <option value="">Choisir un formateur...</option>
                                            <?php foreach ($formateurs as $f): ?>
                                                <option value="<?= htmlspecialchars((string)$f['id']) ?>"><?= htmlspecialchars($f['nom'] . ' ' . $f['prenom']) ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Liste des inscriptions (Utilisateurs / Formateurs)</h4>
                                    ...
                                    <table class="table table-striped align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <tr>
                                                    <td><?= htmlspecialchars($insc['user_nom'] . ' ' . $insc['user_prenom']) ?></td>
                                                    <td><?= htmlspecialchars($insc['user_email']) ?></td>
                                                    <td><strong><?= htmlspecialchars($insc['formateur_nom'] . ' ' . $insc['formateur_prenom']) ?></strong></td>
                                                    <td>
                                                        <form method="POST" class="d-inline" novalidate>
                                                            ...
                                                            <input type="hidden" name="id_formateur" value="<?= htmlspecialchars((string)$insc['id_formateur']) ?>">
