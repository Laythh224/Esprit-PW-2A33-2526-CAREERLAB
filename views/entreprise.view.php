            ...
            <div class="col-md-7 col-lg-6">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form id="companySignupForm" method="POST" novalidate data-signup-form data-form-type="entreprise">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= ($fieldErrors['code_fiscal'] ?? '') !== '' ? 'is-invalid' : '' ?>" id="codeFiscal" name="code_fiscal" placeholder="11 chiffres" value="<?= htmlspecialchars((string) ($old['code_fiscal'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" />
