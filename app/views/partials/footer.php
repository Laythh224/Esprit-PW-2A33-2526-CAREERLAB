            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                    <a href="index.php?route=home" class="navbar-brand">
                        <img src="img/career_lab.png" alt="<?= htmlspecialchars((string) $company['name'], ENT_QUOTES, 'UTF-8'); ?>" style="height: 50px; width: auto; background: #ffffff; padding: 5px 10px; border-radius: 8px;">
                    </a>
