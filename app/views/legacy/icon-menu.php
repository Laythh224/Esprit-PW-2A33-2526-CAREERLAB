            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="base">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="index.php?route=buttons">
                        <span class="sub-item">Buttons</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=gridsystem">
                        <span class="sub-item">Grid System</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=panels">
                        <span class="sub-item">Panels</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=notifications">
                        <span class="sub-item">Notifications</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=sweetalert">
                        <span class="sub-item">Sweet Alert</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=font-awesome-icons">
                        <span class="sub-item">Font Awesome Icons</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=simple-line-icons">
                        <span class="sub-item">Simple Line Icons</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=typography">
              ...
              <li class="nav-item active submenu">
                ...
                <div class="collapse show" id="sidebarLayouts">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="index.php?route=sidebar-style-2">
                        <span class="sub-item">Sidebar Style 2</span>
                      </a>
                    </li>
                    <li class="active">
                      <a href="index.php?route=metiers">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="forms">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="index.php?route=evaluation">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="index.php?route=offres">
                        <span class="sub-item">Basic Table</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=datatables">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="maps">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="index.php?route=elearning">
                        <span class="sub-item">Google Maps</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=jsvectormap">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="charts">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="index.php?route=blog-dashboard">
                        <span class="sub-item">Chart Js</span>
                      </a>
                    </li>
                    <li>
                      <a href="index.php?route=sparkline">
              ...
              <li class="nav-item">
                <a href="index.php?route=widgets">
